          ...
          <section :class="$style.frameSection">
            ...
            <div :class="$style.frameDiv">
              <div :class="$style.div">
                ...
                <p :class="$style.p">
                  家庭暴力及其他創傷事件的兒少與照顧者，提供
                </p>
                <p :class="$style.p">
                  以創傷復原為核心的多元支持服務，在安全與信
                </p>
                <p :class="$style.p">
                  任的氛圍中，陪伴他們逐步走向療癒與重建。
                </p>
