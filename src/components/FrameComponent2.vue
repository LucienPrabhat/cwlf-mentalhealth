...
const PREDEFINED_TEXTS = [
  ...
  '抱抱自己，告訴自己你很棒',
  '好像不管我多努力，都沒有用...',
  '「我知道，你們可能有點不喜歡我」我故作堅強說道。「喔沒有啊～我們就是在霸凌妳！」男孩回應。有好幾次，我躲在那群大部分人的背後啜泣，在廁所裡發洩，卻沒有人為我發聲，除了老師的關心，其他人似乎都是旁觀者。這些他們視為的理所當然，我仍然記得⋯⋯',
  '陽光出來了，我們去散步吧',
  '今天的妳也很棒 抱抱妳 繼續加油',
  '在媽媽面前崩潰大哭，她說：「我生的小孩不會做這種事」',
  '我們已經很棒了別忘了給自己一個讚喔',
  '有時候會覺得我這樣的人，根本不該活在這個世上',
  '希望媽媽可以不要再因為一點點小事就對我大呼小叫',
  '媽媽說憂鬱症是沒用的人才得的',
  '曾經我很恨我的父母，因為在一件事情當中，過錯方是手足卻檢討我，就像是檢討被害者，總是能聽到他們檢討被害者的話，當這種委屈與冤枉被壓在我頭上，我感覺到恨，希望不要跟他們往來（當時是爸爸），而如今對於他們，在提到創傷時我總是有許多憤怒，尤其是針對媽媽，至今我仍然對她感到生氣',
  '不知道有沒有叫做分組恐懼症的東西，從以前就很害怕「分組」，總覺得就是自己的問題，是不是自己不合群、性格差，每次到了分組的時候，總會有被拋棄的感覺，好痛苦',
  '每次開始一段諮商/電訪關懷/換醫生，就像是把那些傷口一遍一遍的撕開來看，剛開始講還會有情緒，可是後來講著講著，這些生命故事就被自己整理成一套公式化的版本，傷口也不知道是不痛了還是麻木了，再說出來已經沒感覺了，甚至可以平靜的，或者笑著說',
  '媽媽在懷我之前就發現爸爸外遇，之後二十幾年內仍發現不少次但從未離婚，總覺得自己不該出生',
  '這裡是可以隨心說出自己內心狀態的地方嗎？',
  '覺得自己很爛 什麼都做不好 常常被罵 被碎念 習慣內耗 變成不太敢表達自己想要什麼',
  '感覺生活喘不過氣，不知道這樣的日子什麼時候才能結束',
]
